...
@Configuration
@EnableEntityViews("org.lamisplus.modules.patient.domain.views")
public class BlazePersistenceConfiguration {

    @PersistenceUnit
    private EntityManagerFactory entityManagerFactory;

    @Bean(name = "PatientCriteriaBuilderFactory")
    ...
    @Bean(name = "PatientEntityViewManager")
    @Scope(ConfigurableBeanFactory.SCOPE_SINGLETON)
    @Lazy(false)
    @Patient
...
//    @Bean(name = "PatientEntityViewIdValueAccessorr")
...
//    }
    ...
    @Bean(name = "EntityViewAwareObjectMapper")
