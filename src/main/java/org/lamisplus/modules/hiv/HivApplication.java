...
@AcrossApplication(
        modules = {
                ...
                AcrossWebModule.NAME, HivModule.NAME
        })
@Slf4j
@EnableSwagger2
@EnableAsync
@EnableScheduling
public class HivApplication extends SpringBootServletInitializer {


    public static void main(String[] args) {

        SpringApplication.run (HivApplication.class, args);
    }


    @Override
    protected SpringApplicationBuilder configure(SpringApplicationBuilder application) {
        return application.sources (HivApplication.class);
    }
