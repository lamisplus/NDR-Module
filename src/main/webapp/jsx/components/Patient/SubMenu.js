        ...
        <div>
            {!props.art && patientObj.commenced!==true ?
                ...
                <Menu size="mini" color={"black"} inverted >
                    ...
                    <Menu.Item onClick={() => loadAdultEvaluation()} > Initial Clinic Evaluation</Menu.Item>
               ...
               (
                <Menu size="mini" color={"black"} inverted>
                    ...
                    <Menu.Item onClick={() => loadAdultEvaluation()} disabled={patientCurrentStatus}> Initial Clinic Evaluation</Menu.Item>
                    ...
                    <Menu.Item onClick={() => loadMentalHealth(patientObj)} >Mental Health Screening</Menu.Item>
